...
import AddingAvatar from '../../styles/ComponentStyles/AddingAvatar';
...
return (
    <>
        <section className={`${style.window} profile`}>
            {renderChoosePhoto && <AddingAvatar renderChoosePhotoHandler={renderChoosePhotoHandler} renderChoosePhoto={renderChoosePhoto}/>}
            ...
            <div className={style.topSector}>
                <div className={style.userData}>
                    ...
                    <div className={style.avatar}>
                      <img src=""/>  {correctProfile && <Fab style={{'width': 40, 'height': 30}} onClick={renderChoosePhotoHandler}><AddIcon /></Fab>}
                    </div>
